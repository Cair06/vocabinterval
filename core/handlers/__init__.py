...
def register_user_commands(router: Router) -> None:
    ...
    # router.message.register(dictionary_command_handler, F.text == 'Словарь')
    ...
    # router.message.register(menu_card_create, CardStates.waiting_for_word)
    ...
    # Регистрация обработчика для ввода нового значения поля
